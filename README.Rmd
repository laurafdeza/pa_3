...
In the third programming assignment we have played with vowel information in English and Spanish.

```{r loads, include=FALSE, echo=FALSE}
library(tidyverse)
library(knitr)
...
```
With the data we created, we could calculate the average F1/F2 centroids and the trajectory length. 

```{r, descriptives, include=TRUE, echo=FALSE}
...
The data also allow to generate some plots on:

```{r, plots, fig.retina=2, fig.height=5, out.width="100%", eval=T, include=TRUE, echo=FALSE}
# Let's plot!
...
```{r, plot5, fig.retina=2, fig.height=5, out.width="100%", eval=T, include=TRUE, echo=FALSE}
